...
public class Playground {
    ...
    private Map<Integer, Image> additionalImages = new HashMap<>();

    public Playground(int numberOfColumns, int numberOfRows) {
    ...
    private void init(int numberOfColumns, int numberOfRows) {
